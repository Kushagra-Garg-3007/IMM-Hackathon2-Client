...
const Home = () => {
  ...
  const getScholarships = async (filters = {}) => {
    ...
    try {
      ...
      const res = await axios.get(`https://scholarship-ybb2.onrender.com/scholarship/show?${queryParams}`, { withCredentials: true });
  ...
  const handleApply = async (id) => {
    try {
      const res = await axios.get(`https://scholarship-ybb2.onrender.com/scholarship/apply/${id}`, { withCredentials: true });
